...
class WP2D_Contextual_Help {
	...
	private function _add_post_type_tabs() {
		get_current_screen()->add_help_tab( array(
			...
			'content'  => '<p>' . sprintf(
				esc_html__( 'For detailed information, refer to the contextual help on the %sWP to diaspora*%s settings page.', 'Placeholders represent the link.', 'wp_to_diaspora' ),
